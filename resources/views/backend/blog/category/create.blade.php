...
@section('content')
    <nav aria-label="breadcrumb" class="paths-nav">
        <ol class="breadcrumb breadcrumb-inverse">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{__('backend.create_category')}}</li>
        </ol>
    </nav>
    <div class="card card-default mt-2">
        <div class="card-header card-header-border-bottom justify-content-between">
            <h2>{{__('backend.create_new_category')}}</h2>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="{{__('backend.enter')}} {{__('backend.category')}} {{__('backend.form_name')}}" value="{{old('name')}}">
                            @error('name')
