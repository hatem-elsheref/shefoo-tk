...
@section('content')
    <nav aria-label="breadcrumb" class="paths-nav">
        <ol class="breadcrumb breadcrumb-inverse">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{__('backend.edit_tag')}}</li>
        </ol>
    </nav>
    <div class="card card-default mt-2">
        <div class="card-header card-header-border-bottom justify-content-between">
            <h2>{{__('backend.edit_tag')}}</h2>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="{{__('backend.enter')}} {{__('backend.tag')}} {{__('backend.form_name')}}" value="{{$tag->name}}">
                            @error('name')
